                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group featured_image_block">
                                            <x-inputs.file-input name="featured_image" id="featured_image"
                                                accept="image/*" label="{{ __('Featured Image') }}" :existingAttachment="$sessionFeatured
                                                    ? asset('storage/' . $sessionFeatured)
                                                    : null"
                                                :existingAltText="isset($property) ? $property->title : ''" :removeCheckboxLabel="__('Remove featured image')" class="mt-1">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group property-images">
                                            <x-inputs.file-input name="images[]" id="images" accept="image/*"
                                                label="{{ __('Property Images') }}" :existingAttachment="$sessionImages" :existingAltText="isset($property) ? $property->title : ''"
                                                :removeCheckboxLabel="__('Remove image')" class="mt-1" :multiple="true" :removeCheckboxName="'remove_images'">
                                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300">
...
@push('scripts')
    <script>
        $("#submitBtn").on("click", function(e) {
            ...
            // Extra keys you are adding manually
