                                ...
                                @if (in_array(session('post_property.mainType'), [
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="d-inline-flex align-items-center flex-wrap group-20">
                                            ...
                                            @endforeach
                                            <button id="3plusbalconies" type="button" data-value="3+"
                                                data-id="3plusbalconies"
                                                class="balconies btn btn-sm btn-primary @if (isset($post['balconies']) && $post['balconies'] == '3plusbalconies') active @endif">More
                                                Than 3</button>
                                        </div>
                                    </div>
                                @endif
