        ...
        <div class="lg:col-span-3 space-y-6">
            <div class="rounded-md border bg-white dark:border-gray-800 dark:bg-gray-900 p-5 space-y-4 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label block text-sm font-medium text-gray-700 dark:text-gray-300>{{ __('Location') }} <span
                                class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        <label block text-sm font-medium text-gray-700 dark:text-gray-300>{{ __('Price') }} <span
                                class="text-red-500">*</span></label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1 hiddeninput">
                        <label block text-sm font-medium text-gray-700 dark:text-gray-300>{{ __('Bedrooms') }}</label>
                    ...
                    <div class="space-y-1 hiddeninput">
                        <label block text-sm font-medium text-gray-700 dark:text-gray-300>{{ __('Kitchens') }}</label>
                    ...
                    <div class="space-y-1 hiddeninput">
                        <label block text-sm font-medium text-gray-700 dark:text-gray-300>{{ __('Bathrooms') }}</label>
                    ...
                    <div class="space-y-1">
                        <x-inputs.combobox name="current_status" label="{{ __('Currenct Status') }}"
                ...
                <div class="space-y-1">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                        {{ __('Smart Home Features') }} <span class="text-red-500">*</span>
                    </label>
                    @php
